...
SWEP.MalfunctionMean = 75 -- The mean number of shots between malfunctions, will be autocalculated if nil
...
SWEP.Animations = {
    ...
    ["fix"] = {
		...
		{s = "Firearms2.Cloth_Movement", t = 0.76},
		{s = "Firearms2.SAKO95_BoltBack", t = 0.76},
		{s = "Firearms2.Cloth_Movement", t = 0.96},
		{s = "Firearms2.SAKO95_BoltForward", t = 0.96}
		},
    },
    ["reload"] = {
        Source = "reload",
