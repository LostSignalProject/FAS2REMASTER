...
SWEP.MalfunctionMean = 14 -- The mean number of shots between malfunctions, will be autocalculated if nil
...
SWEP.Hook_SelectReloadAnimation = function(wep, anim)
    if wep.Attachments[2].Installed then return anim .. "_nomen" end
end
